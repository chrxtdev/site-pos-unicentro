...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-emerald-500 text-start text-base font-medium text-emerald-400 bg-emerald-500/10 focus:outline-none focus:text-emerald-300 focus:bg-emerald-500/20 focus:border-emerald-400 transition duration-150 ease-in-out'
